...
describe('Cooperation Component', () => {
  ...
  beforeEach(() => {
    ...
    mockUseLocation.mockReturnValue({
      state: {
        selectedTeammates: [{ _id: '1', firstName: 'John', lastName: 'Doe' }],
        teamName: 'Team Alpha',
        teamId: '123',
        updatedTeammates: [{ _id: '1', firstName: 'John', lastName: 'Doe' }],
      },
    });
    jest.mock('react-router-dom', () => ({
  ...
  it('should navigate to PeerRating when Rate button is clicked', () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/PeerRating/123/1', expect.objectContaining({
