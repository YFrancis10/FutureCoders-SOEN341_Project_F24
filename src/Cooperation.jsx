    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 text-gray-200">
      ...
      {/* Page Header */}
        <div className=" mt-6 max-w-7xl mx-auto px-4">
          <h1 className="text-3xl font-bold text-gray-100">Team Evaluation: {teamName}</h1>
        </div>


      {/* Main Content */}
      <main className="max-w-7xl mx-auto px-4 py-6">
        <h2 className="text-xl font-semibold mb-4">Rate Your Teammates</h2>
        {remainingTeammates.length > 0 ? (
          ...
          <div className="bg-gray-800 p-6 rounded-lg text-center shadow-md">
            <h3 className="text-2xl font-bold mb-2 text-gray-100">Submission Confirmed!</h3>
            <p className="text-lg text-gray-300">All teammates have been rated. Thank you for your submission!</p>
          </div>
        )}
