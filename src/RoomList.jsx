      ...
      <div className=" mt-6 max-w-7xl mx-auto px-4">
        ...
        <main>
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            {rooms.length > 0 ? (
              rooms.map((room) => (
                <div key={room._id} className="p-4 rounded-lg shadow-md border border-gray-200 mb-4 flex justify-between items-center hover:bg-black transition duration-150 ease-in-out glass">
                  <div>
                    <h2 className="text-xl font-semibold">{room.roomName}</h2>
                    <p className="text-black">Capacity: {room.capacity}</p>
                  </div>
                  <Link
