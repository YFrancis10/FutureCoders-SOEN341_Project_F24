        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="w-full flex flex-col">
            <div className="mt-6 w-1/2">
              ...
              {/* Cooperation Rating */}
              <label className="text-lg font-semibold text-gray-300">Cooperation</label>
              <select
                value={cooperation}
              ...
              {/* Conceptual Contribution Rating */}
              <label className="text-lg font-semibold text-gray-300 mt-4">Conceptual Contribution</label>
              <select
              ...
              {/* Practical Contribution Rating */}
              <label className="text-lg font-semibold text-gray-300 mt-4">Practical Contribution</label>
              <select
                value={practicalContribution}
                onChange={(e) => setPracticalContribution(e.target.value)}
                className="mt-1 block w-full rounded-md border border-gray-300 bg-gray-800 text-white shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              >
                <option value="">Select Rating</option>
                {ratingOptions.map((option) => (
              ...
              {/* Work Ethic Rating */}
              <label className="text-lg font-semibold text-gray-300 mt-4">Work Ethic</label>
              <select
                value={workEthic}
              ...
              {/* Comment */}
              <label className="text-lg font-semibold text-gray-300 mt-4">Comments</label>
              <textarea
                value={comment}
                onChange={(e) => setComment(e.target.value)}
                className="mt-1 block w-full rounded-md border border-gray-300 bg-gray-800 text-white shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
