        ...
        <Router>
            <Routes>
                ...
                <Route
                    ...
                    element={
                        <Layout pageTitle="Team Evaluation">
                            <TeamEvaluation />
                        </Layout>
                    }
                />
                ...
                />
                <Route
                    path="/PeerRating/:teamId/:studentId"
                    element={
                        <Layout pageTitle="Peer Rating">
                            <PeerRating />
                        </Layout>
                    }
                />
                ...
                <Route
                    ...
                    element={
                        <Layout pageTitle="Book Room">
                            <BookRoom />
                        </Layout>
                    }
                />
                <Route
                    path="/teams/:teamId/detailed-results"
                    element={
                        <Layout pageTitle="Detailed Results">
                            <DetailedResults />
                        </Layout>
                    }
                />
