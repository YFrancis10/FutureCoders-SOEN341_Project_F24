    ...
    useEffect(() => {
        const fetchStudentData = async () => {
            try {
                ...
                const response = await axios.get(
                    'http://localhost:5001/student/me',
                    {
        ...
        const fetchTeams = async () => {
            try {
                const token = localStorage.getItem('token');
                const response = await axios.get(
                    'http://localhost:5001/student/teams',
                    {
                        headers: { Authorization: `Bearer ${token}` },
                    }
                );
                        ...
                        <div className="mt-4 space-y-4">
                            {teams.length > 0 ? (
                                teams.map((team) => (
                                    <div
                                        key={team._id}
                                        className="bg-gray-100 p-4 rounded-lg shadow-md border border-gray-200 hover:bg-gray-200 transition duration-150 ease-in-out"
                                    >
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex flex-col items-center space-y-2">
                                                <button
                                                    ...
                                                    className="rounded-md bg-gradient-to-b from-blue-500 to-blue-400 text-white px-4 py-2 text-sm font-medium"
                                                >
                                                    Evaluate Team
                                                </button>
                                                <button
                                                    ...
                                                    className="rounded-md bg-gradient-to-b from-green-500 to-green-400 text-white px-4 py-2 text-sm font-medium"
                                                >
                                                    Book a Study Room
                                                </button>
                                            </div>
