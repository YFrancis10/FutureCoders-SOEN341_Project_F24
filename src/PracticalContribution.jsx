...
const PracticalContribution = () => {
  ...
  const handleRate = (teammate) => {
    navigate(`/PeerRating/Practical/${teamId}/${teammate._id}`, { state: { teammate } });
  };
    ...
    <>
      ...
      <header className="bg-white shadow">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Team Practical Contribution Evaluation</h1>
        </div>
      </header>
      <main className="ml-0">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
