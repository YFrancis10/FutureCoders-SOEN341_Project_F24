...
const PeerRating3 = () => {
  ...
  const submitRating = async () => {
    if (!practicalContribution || practicalContribution < 1 || practicalContribution > 5) {
      setError('Please select a valid practical contribution rating (1-5).');
      return;
    }
    ...
    try {
      ...
      const response = await axios.post(
        ...
        { rateeId: studentId, practicalContribution, comment },
        ...
        <header className="bg-white shadow">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">
              Team Practical Contribution Evaluation
            </h1>
          </div>
        </header>
            ...
            <div className="w-full flex flex-col">
              <div className="mt-6 w-1/2">
                <div className="mb-4">
                  ...
                  <br />
                  <label htmlFor="practicalContribution" className="block text-lg font-medium text-gray-900">
                    Practical Contribution Rating (1-5):
                  </label>
                  <select
