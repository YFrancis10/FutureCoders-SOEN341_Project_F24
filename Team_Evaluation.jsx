...
const TeamEvaluation = () => {
  ...
  const handleTeammateChange = (e) => {
    ...
    if (checked) {
      setSelectedTeammates([...selectedTeammates, value]);
    } else {
      setSelectedTeammates(selectedTeammates.filter((teammate) => teammate !== value));
    }
  };
  ...
  const handleSubmit = (e) => {
    ...
    // Here you can submit the evaluation to the server
  };
  ...
  return (
    <>
      <div className="min-h-full">
        ...
        <main className="ml-0"> {/* Modified class for alignment */}
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div className="max-w-2xl py-6 px-4"> {/* Removed "mx-auto" */}
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  className="bg-blue-500 hover:bg-blue-600 text-white px-10 py-2 rounded">
                  Rate
                </button>
