...
const WorkEthic = () => {
  ...
  const handleRateTeammate = (teammate) => {
    // Navigate to PeerRating4 and pass only teammates left to be rated
    navigate(`/PeerRating4/${teamId}/${teammate._id}`, {
      state: {
        teammate,
    ...
    <div className="min-h-full">
      ...
      <header className="bg-white shadow">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Team {teamName}: Work Ethic Evaluation</h1>
        </div>
      </header>
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          ...
          {remainingTeammates.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center text mt-8 bg-gray-100 p-6 border border-gray-200 rounded-lg shadow-lg max-w-xl mx-auto">
              ...
              <p className="text-lg">Thank you for submitting your work ethic peer assessment.</p>
            </div>
          )}
